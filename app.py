...
with right:
    ...
    if "hunger_level" not in st.session_state:
    ...
    st.markdown(
        f"""
        <style>
        .st-key-hunger_{selected_hunger}
        .stButton > button {{
